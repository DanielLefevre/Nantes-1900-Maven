...
public final class ParserSTLTest extends TestCase {
    ...
    public static void testReadWriteSTL() {
        try {
            ...
            final STLWriter writerA = new STLWriter("WriterTestA.stl");
            writerA.setMesh(write);
            writerA.setWriteMode(STLWriter.ASCII_MODE);
            writerA.write();

            final STLWriter writerB = new STLWriter("WriterTestB.stl");
            writerB.setMesh(write);
            writerA.setWriteMode(STLWriter.BINARY_MODE);
            writerB.write();
