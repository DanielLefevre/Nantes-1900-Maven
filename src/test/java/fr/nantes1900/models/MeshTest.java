...
public class MeshTest extends TestCase {
     ...
     */
    @Test
    public static final void testInPlanes() {
     ...
     */
    @Test
    public static final void testIntersection() {
        try {
     ...
     */
    @Test
    public static final void testIsOrientedAs() {
        final Point point1 = new Point(0, 0, 0);
        final Vector3d vector1 = new Vector3d(0, 0, 1);
        final Edge edge1 = new Edge(point1, point1);
    ...
    /**
     * Test method for
     * {@link fr.nantes1900.models.basis.Mesh#minimalDistance(fr.nantes1900.models.basis.Mesh)}
     * .
     */
    @Test
    public static final void testMinimalDistance() {
        final Point point1 = new Point(1, 0, 0);
        final Point point2 = new Point(0, 1, 0);
        final Point point3 = new Point(0, 0, 0);
     ...
     */
    @Test
    public static final void testReturnUnsortedBounds() {
