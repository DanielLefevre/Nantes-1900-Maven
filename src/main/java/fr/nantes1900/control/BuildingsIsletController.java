...
public class BuildingsIsletController {
    ...
    /**
     * Saves the current islet state, using an AbstractWriter.
     * @param fileName
     *            the name of the file
     * @param writerType
     *            the type of the writer : AbstractWriter.CITYGML_WRITER, or
     *            AbstractWriter.STL_WRITER
     */
    public final void saveFinalResults(final String fileName,
            final int writerType) {
