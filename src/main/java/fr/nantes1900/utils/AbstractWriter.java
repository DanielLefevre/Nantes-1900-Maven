 ...
 * add new writers without changing the rest of the code. Implemented writers
 * have to inherit the AbstractWriter.
 * @author Nicolas REY
 */
public abstract class AbstractWriter {
    ...
    /**
     * Setter. Sets the name of the file to be written.
     * @param fileNameIn
